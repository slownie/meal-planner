...
import {View,Text,StyleSheet,ScrollView,TouchableOpacity,Alert,Keyboard,KeyboardAvoidingView,Button} from 'react-native';
            ...
            <ScrollView contentInsetAdjustmentBehavior="automatic" showsVerticalScrollIndicator={false}>
                ...
                <KeyboardAvoidingView
                    ...
                    */}
                    ...
                    <Button title='Create a new Recipe' onPress={() => navigation.navigate('CreateRecipe')}/>
                </KeyboardAvoidingView>
                ...
                <View style = {styles.recipeList}>
                    ...
                    {/* Recipe Items */}
                    {
                        recipeItems.map((item, index) => {
                                return (
                                    <TouchableOpacity key={item.id} onPress={() => Alert.alert('Delete recipe?', 'Are you sure you want to delete this recipe?', 
                                    [
                                        {text:'Cancel'},
